...
public class LoaclPlayerDefense : LoaclPlayerState
{
    public LoaclPlayerDefense(LoaclPlayer _player, LoaclPlayerMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
