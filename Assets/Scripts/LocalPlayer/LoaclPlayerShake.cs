...
public class LoaclPlayerShake : LoaclPlayerState
{
    private string check;

    public LoaclPlayerShake(LoaclPlayer _player, LoaclPlayerMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
