...
public class LocalPlayerTired : LoaclPlayerState
{
    public LocalPlayerTired(LoaclPlayer _player, LoaclPlayerMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
