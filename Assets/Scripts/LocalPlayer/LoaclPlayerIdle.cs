...
public class LoaclPlayerIdle : LoaclPlayerState
{
    public LoaclPlayerIdle(LoaclPlayer _player, LoaclPlayerMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
