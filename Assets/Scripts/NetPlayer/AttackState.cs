...
{
    public AttackState(Player _player, PlayerStateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
    }
    ...
    public override void Enter()
    {
        ...
        player.photonView.RPC("RPC_TriggerAttack", RpcTarget.All);
    }
